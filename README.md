...
5. ***若出现fetch failed错误，大概率是需要配置代理。 若不想配置代理情使用[![ZodGame-Auto-Checkin](https://github.com/ewigl/zodgame-auto-checkin/actions/workflows/Checkin.yml/badge.svg)](https://github.com/ewigl/zodgame-auto-checkin)项目于github A Actions部署***
